...
const productos = {
    tortas: [
        { nombre: "Torta de Cochinita Pibil", precio: 41, img: "img/TortaCochina22.jpeg" },
        { nombre: "Torta de Pollo Pibil", precio: 41, img: "img/TortaCochina.jpeg" },
        { nombre: "Torta de Queso Panela", precio: 41, img: "img/TortaChoriqueso1.jpeg" },
        { nombre: "Torta de Jamón Envinado", precio: 43, img: "img/Torta_env.jpeg" },
        { nombre: "Torta de Huevo con Chorizo", precio: 41, img: "img/TortaChorizo2.jpeg" },
        { nombre: "Torta de Choriqueso", precio: 41, img: "img/TortaChoriqueso1.jpeg" },
        { nombre: "Torta de Chorizo", precio: 41, img: "img/TortaChorizo2.jpeg" },
        { nombre: "Torta de Choripapa", precio: 41, img: "img/TortaChoripapa.jpeg" },
        { nombre: "Torta de Chorizo Argentino", precio: 43, img: "img/TortaChArg.jpeg" },
        { nombre: "Torta de Pierna Enchilada", precio: 41, img: "img/TortaPierna.jpeg" }
    ],
    pambazos: [
        ...
        { nombre: "Pambazo de Jamon Envinado", precio: 34, img: "img/PambazoPierna.jpeg" },
        { nombre: "Pambazo de Chorizo Argentino", precio: 34, img: "img/PambazoChorizoArg.jpeg" },
        { nombre: "Pambazo de Choripapa", precio: 32, img: "img/PambazoChoripapa.jpeg" }
    ],
    bebidas: [
        { nombre: "Agua de Jamaica", precio: 30, img: "img/Aguajamaica.jpeg" },
        { nombre: "Agua de Horchata", precio: 30, img: "img/aguaHorchata.jpeg" },
        { nombre: "Agua de Tamarindo", precio: 30, img: "img/aguaHorchata.jpeg" },
        { nombre: "Agua de Piña Colada", precio: 30, img: "img/aguaHorchata.jpeg" },
        { nombre: "Agua Embotellado", precio: 15, img: "img/agua.jpeg" },
        { nombre: "Arizona", precio: 34, img: "img/Arizona.jpg" },
        { nombre: "Refresco(600 ml)", precio: 35, img: "img/Coca.jpeg" },
        ...
        { nombre: "Licuado de Avena", precio: 35, img: "img/Licuadoavena.jpg" },
        { nombre: "Chocomilk", precio: 30, img: "img/chocomilk.jpeg" },
        { nombre: "Capuchino", precio: 45, img: "img/capuchino.jpeg" },
