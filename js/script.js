...
const productos = {
    ...
    bebidas: [
        ...
        { nombre: "Agua de Tamarindo", precio: 25, img: "img/agua.jpg" },
        { nombre: "Agua de Piña Colada", precio: 25, img: "img/agua.jpg" },
        { nombre: "Agua Embotellado", precio: 15, img: "img/agua.jpg" },
        { nombre: "Arizona", precio: 34, img: "img/agua.jpg" },
        { nombre: "Refresco(600 ml)", precio: 34, img: "img/Coca.jpeg" },
        { nombre: "Cerveza de Raíz", precio: 35, img: "img/refresco.jpg" },
        { nombre: "Cafe Americano", precio: 35, img: "img/agua.jpg" },
        ...
        { nombre: "Capuchino", precio: 40, img: "img/refresco.jpg" },
        { nombre: "Jumex Vidrio", precio: 34, img: "img/agua.jpg" },
    ],
    postres: [
